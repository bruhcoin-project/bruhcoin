...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bruhcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bruhcointools.com", "138.197.103.212"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"bruhcointools.com", "testnet-seed.bruhcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bruhcoin is probably already running."), addrBind.ToString().c_str());
        else
